		...
		addButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				if ( inc.addItem( _id , name ) )
					Toast.makeText( InventoryActivity.this , "Insert Success" , Toast.LENGTH_LONG ).show();
				else
					Toast.makeText( InventoryActivity.this , "Insert Failed" , Toast.LENGTH_LONG ).show();
			}
		});
		...
		selectButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if ( item != null )
					...
					Toast.makeText( InventoryActivity.this , "Select Failed" , Toast.LENGTH_LONG ).show();
